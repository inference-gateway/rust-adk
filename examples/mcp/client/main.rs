...
async fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    info!("MCP A2A client connecting to {server_url}");
    ...
    let prompts = [
        "List the MCP tools you can reach.",
        "Use an MCP tool to help me, then summarise what it returned.",
    ];
